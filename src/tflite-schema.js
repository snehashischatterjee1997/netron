...
$root.tflite.SparsityParameters = class SparsityParameters {
    ...
    static decodeText(reader, json) {
        ...
        $.dim_metadata = reader.array_(json.dim_metadata, $root.tflite.DimensionMetadata.decodeText);
        return $;
    }
};
...
$root.tflite.Tensor = class Tensor {
    ...
    static decode(reader, position) {
        ...
        $.quantization = reader.object(position, 12, $root.tflite.QuantizationParameters.decode);
        $.is_variable = reader.bool_(position, 14, false);
        $.sparsity = reader.object(position, 16, $root.tflite.SparsityParameters.decode);
...
$root.tflite.SubGraph = class SubGraph {
    ...
    static decodeText(reader, json) {
        const $ = new $root.tflite.SubGraph();
        $.tensors = reader.array_(json.tensors, $root.tflite.Tensor.decodeText);
        $.inputs = reader.array(json.inputs, Int32Array);
        $.outputs = reader.array(json.outputs, Int32Array);
        $.operators = reader.array_(json.operators, $root.tflite.Operator.decodeText);
        $.name = reader.value(json.name, null);
        return $;
    }
};
...
$root.tflite.Model = class Model {
    ...
    static decodeText(reader, json) {
        ...
        $.operator_codes = reader.array_(json.operator_codes, $root.tflite.OperatorCode.decodeText);
        $.subgraphs = reader.array_(json.subgraphs, $root.tflite.SubGraph.decodeText);
        $.description = reader.value(json.description, null);
        $.buffers = reader.array_(json.buffers, $root.tflite.Buffer.decodeText);
        $.metadata_buffer = reader.array(json.metadata_buffer, Int32Array);
        $.metadata = reader.array_(json.metadata, $root.tflite.Metadata.decodeText);
        return $;
    }
};
...
$root.tflite.ImageProperties = class ImageProperties {
    ...
    static decode(reader, position) {
        ...
        $.default_size = reader.object(position, 6, $root.tflite.ImageSize.decode);
        return $;
    }
};
...
$root.tflite.Content = class Content {
    ...
    static decode(reader, position) {
        ...
        $.range = reader.object(position, 8, $root.tflite.ValueRange.decode);
        return $;
    }
};
...
$root.tflite.TensorMetadata = class TensorMetadata {
    ...
    static decode(reader, position) {
        ...
        $.content = reader.object(position, 10, $root.tflite.Content.decode);
        $.process_units = reader.array_(position, 12, $root.tflite.ProcessUnit.decode);
        $.stats = reader.object(position, 14, $root.tflite.Stats.decode);
